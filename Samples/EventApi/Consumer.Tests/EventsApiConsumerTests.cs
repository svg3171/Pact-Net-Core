...
namespace Consumer.Tests
{
    public class EventsApiConsumerTests : IClassFixture<ConsumerEventApiPact>
    {
        ...
        public EventsApiConsumerTests(ConsumerEventApiPact consumerEventApiPact)
        {
            _mockProviderService = consumerEventApiPact.MockProviderService;
            _mockProviderServiceBaseUri = consumerEventApiPact.MockProviderServiceBaseUri;
